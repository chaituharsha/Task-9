...
<div class="form-row">
    <div class="form-group col-md-4">        
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="inlinecupcake" value="cupcake">
            <label class="form-check-label" for="inlinecupcake">cupcake</label>
        </div>
    </div>
    <div class="form-group col-md-4">
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="inlinepasta" value="pasta">
            <label class="form-check-label" for="inlinepasta">pasta</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="inlinemomos" value="momos">
            <label class="form-check-label" for="inlinemomos">momos</label>
        </div>
    </div>
    <div class="form-group col-md-4">
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="inlinetandoori" value="tandoori">
            <label class="form-check-label" for="inlinetandoori">tandoori</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="inlinefajitas" value="fajitas">
            <label class="form-check-label" for="inlinefajitas">fajitas</label>
        </div>
    </div>
</div>
<div class="form-group">
  <label for="inputAddress">Address</label>
  <input type="text" name="address1" class="form-control" id="inputAddress" placeholder=" Main Street" required>
</div>
<div class="form-group">
